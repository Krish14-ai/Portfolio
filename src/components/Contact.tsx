                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <a href="mailto:krish@example.com" className="flex items-center gap-4 group">
                                ...
                                <span className="text-lg text-gray-300 group-hover:text-white transition-colors">krish@example.com</span>
                            </a>
                            ...
                            <Link href="https://github.com" target="_blank" className="flex items-center gap-4 group">
                                ...
                                <span className="text-lg text-gray-300 group-hover:text-white transition-colors">github.com/krish</span>
                            </Link>
                            ...
                            <Link href="https://linkedin.com" target="_blank" className="flex items-center gap-4 group">
                                ...
                                <span className="text-lg text-gray-300 group-hover:text-white transition-colors">linkedin.com/in/krish</span>
                            </Link>
                        </div>
                    </motion.div>
